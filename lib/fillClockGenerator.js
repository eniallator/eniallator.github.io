...
var inputCommands = fs.readFileSync('Example input.txt').toString().split('\r\n');
...
inputCommands.forEach(function iterator(command, index){
	index += 2;
...
fs.writeFileSync("generatedOutput.txt",outputCommands.join("\n"));